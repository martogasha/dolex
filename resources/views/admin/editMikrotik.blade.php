...
<title>Edit {{$edit->name}} | Henix</title>
        ...
        <div class="dashboard-content-one">
            ...
            <div class="card height-auto">
                <div class="card-body">
                    ...
                    <form action="{{url('editMik')}}" method="post">
                        @csrf
                        <input type="hidden" value="{{$edit->id}}" name="mikrotik_id">
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                <label>IP Address *</label>
                                <input type="text" class="form-control" value="{{$edit->ip}}" name="mikrotik_ip" required>
                            </div>
                          
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                <label>User *</label>
                                <input type="text" class="form-control" value="{{$edit->user}}" name="mikrotik_user" required>
                            </div>
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
